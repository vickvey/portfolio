      ...
      <div className="flex lg:flex-row">
        <div className="flex flex-col gap-8 max-w-2xl">
          <h1 className="lg:text-7xl font-extrabold">
            Hi, I&apos;m Alex - a Full Stack Developer with a passion for
            Natural Language Processing.
          </h1>
          <h3>
            I&apos;m a 4th-year computer science student building scalable web
            apps and experimenting with natural language models to make tech
            more human.
          </h3>
        ...
        <div id="some-thing-should-be-here"></div>
      </div>
    </section>
  );
}
